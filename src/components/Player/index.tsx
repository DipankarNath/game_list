      ...
      <div className="flex justify-between gap-2 m-2">
        <div>
          ...
          <input
            ...
            value={name}
            className="w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-[#005e91]"
        ...
        <div>
          ...
          <input
            ...
            max={60}
            value={age || ""}
            className="w-[70px] rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-[#005e91]"
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
